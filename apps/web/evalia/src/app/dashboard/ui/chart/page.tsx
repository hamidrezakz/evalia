...
export default function DashboardOverviewPage() {
  ...
  const [exportTarget, setExportTarget] = React.useState<
    "employees" | "activities" | "tasks" | "headcount" | "roles"
  >("employees");
  ...
  const summaryForRange = React.useMemo(
    () => ({
      ...
      activeRate: avgActiveRateCurrent,
      hiresThisPeriod: sumHiredCurrent,
      leavesThisPeriod: sumLeftCurrent,
    }),
    [avgTotalCurrent, avgActiveRateCurrent, sumHiredCurrent, sumLeftCurrent]
  );
  ...
  function getExportData(target: typeof exportTarget): {
    ...
    if (target === "employees") {
      return {
        name: "employees",
        headers: ["شناسه", "نام", "سمت", "تیم", "تاریخ استخدام", "وضعیت"],
    ...
    if (target === "headcount") {
      return {
        name: "headcount",
        headers: ["ماه", "استخدام", "ترک خدمت", "خالص تغییر"],
  ...
  return (
    <div className="min-h-[100svh] space-y-8 p-4 md:p-6 relative">
      ...
      <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
        ...
        <DialogContent className="max-w-md w-[96%] p-6" showCloseButton>
          <DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Badge>
                  نرخ فعال:{" "}
                  {formatFa(summaryForRange.activeRate, { percent: true })}
                </Badge>
                <Badge variant="outline">
                  استخدام: {formatFa(summaryForRange.hiresThisPeriod)}
                </Badge>
                <Badge variant="outline">
                  ترک خدمت: {formatFa(summaryForRange.leavesThisPeriod)}
                </Badge>
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  <SelectContent dir="rtl">
                    <SelectItem value="employees">پرسنل جدید</SelectItem>
                    <SelectItem value="activities">فعالیت‌های اخیر</SelectItem>
                    <SelectItem value="tasks">فهرست وظایف</SelectItem>
                    <SelectItem value="headcount">استخدام/ترک خدمت</SelectItem>
                    <SelectItem value="roles">ترکیب نقش‌ها</SelectItem>
                  </SelectContent>
                </Select>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
        <KpiPanel
          ...
          title="کل پرسنل"
          description="میانگین دوره انتخابی"
      ...
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
        <Panel>
          <PanelHeader>
            <PanelTitle>شاخص مشارکت سازمانی</PanelTitle>
        ...
        <Panel>
          <PanelHeader>
            <PanelTitle>ترکیب نقش‌های سازمانی</PanelTitle>
            <PanelDescription>سهم هر نقش</PanelDescription>
          </PanelHeader>
          <PanelContent className="h-[320px] w-full justify-center items-center">
            <ChartContainer config={chartConfig} className="h-full w-full">
              <PieChart>
        ...
        <Panel>
          <PanelHeader>
            <PanelTitle>استخدام و ترک خدمت</PanelTitle>
            <PanelDescription>دینامیک منابع انسانی</PanelDescription>
          </PanelHeader>
          <PanelContent className="h-[320px] w-full justify-center items-center">
            <ChartContainer config={chartConfig} className="h-full w-full">
      ...
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
        <Panel>
          <PanelHeader>
            ...
            <PanelDescription>میانگین امتیاز حوزه‌ها</PanelDescription>
          </PanelHeader>
        ...
        <Panel>
          <PanelHeader>
            <PanelTitle>نرخ فعال</PanelTitle>
            <PanelDescription>
              درصد پرسنل فعال از کل در {range} ماه اخیر
            </PanelDescription>
          </PanelHeader>
          <PanelContent className="h-[360px] w-full justify-center items-center">
            <ChartContainer
      ...
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-2">
        {/* پرسنل جدید (جدول یکدست) */}
        <Panel className="overflow-hidden">
          <PanelHeader>
            <PanelTitle>پرسنل جدید</PanelTitle>
            <PanelAction>
            ...
            <PanelDescription>آخرین استخدام‌ها</PanelDescription>
          </PanelHeader>
          <PanelContent className="group w-full">
            <div className="overflow-x-hidden group-hover:overflow-x-auto whitespace-nowrap scrollbar-thin scrollbar-hide">
              {" "}
        ...
        <Panel className="overflow-hidden">
          <PanelHeader>
            <PanelTitle>فعالیت‌های سازمانی</PanelTitle>
            <PanelAction>
              <Button variant="secondary" size="sm" className="text-[10px]">
                <MoreHorizontal className="size-4" />
                مشاهده بیشتر
          ...
          <PanelContent className="w-full overflow-x-auto">
            <Table className="min-w-[420px]">
              ...
              <TableBody>
                {dashboardTasks.map((t: DashboardTask) => (
                  <TableRow key={t.id}>
                    ...
                    <TableCell>
                      <Badge variant={priorityToVariant((t as any).priority)}>
                        {priorityFa((t as any).priority)}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <Badge variant={statusToVariant((t as any).status)}>
                        {statusFa((t as any).status)}
                      </Badge>
                    </TableCell>
                  </TableRow>
                ))}
        ...
        <Panel className="overflow-hidden">
          <PanelHeader>
            <PanelTitle>رویدادهای اخیر سازمان</PanelTitle>
            <PanelAction>
              <Button variant="secondary" size="sm" className="text-[10px]">
                <MoreHorizontal className="size-4" />
                مشاهده بیشتر

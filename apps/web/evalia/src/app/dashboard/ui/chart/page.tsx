...
export default function ChartsShowcasePage() {
  ...
  return (
    <div className="min-h-[100svh] space-y-8 p-6">
      {/* کنترل‌های تمام‌عرض بالای صفحه */}
      <Panel className="w-full">
        <PanelContent className="flex flex-wrap items-center justify-between gap-3 py-2">
          <div className="flex items-center gap-2">
            <ToggleGroup
              ...
              <ToggleGroupItem value="3">۳ ماهه</ToggleGroupItem>
              <ToggleGroupItem value="6">۶ ماهه</ToggleGroupItem>
              <ToggleGroupItem value="12">۱۲ ماهه</ToggleGroupItem>
            </ToggleGroup>
          </div>
          <div className="flex items-center gap-2">
            <ToggleGroup
              ...
              <ToggleGroupItem value="total" className="text-[12px]">نمایش کل</ToggleGroupItem>
              <ToggleGroupItem value="active" className="text-[12px]">نمایش فعال</ToggleGroupItem>
            </ToggleGroup>
          </div>
        </PanelContent>
      </Panel>
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <Panel>
          ...
          <PanelContent className="w-full h-[320px]">
